...
export interface SensorData {
  ...
  wx?: number;              // Angular velocity X (deg/s) (from IMU)
  wy?: number;              // Angular velocity Y (deg/s) (from IMU)
  wz?: number;              // Angular velocity Z (deg/s) (from IMU)
  ax?: number;              // Acceleration X (g) (from IMU)
  ay?: number;              // Acceleration Y (g) (from IMU)
  az?: number;              // Acceleration Z (g) (from IMU)
